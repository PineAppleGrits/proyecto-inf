  ...
  function onSubmit(event) {
    ...
    axios
      ...
      .then(({ data }) => {
          ...
          let exampleChannelKey = Object.keys(data.channels)[0];
          console.log(exampleChannelKey)
          let exampleChannel = data.channels[exampleChannelKey];
        props.history.push(`/channel/${data._id}/${exampleChannelKey}`);
      ...
      <div className="container-1CE3eW">
        ...
        {/*       <div className="uploadIcon-2IFzZU">
              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="colorMuted-HdFt4q size12-3cLvbJ guidelines-1NSoht">
...
export default withRouter(connect(mapStateToProps)(CreateServerModal));
