  ...
  return (
    ...
    >
      <div className="content-3YMskv" style={{ height: "266px" }}>
        ...
        >
          ...
          >
            ...
            {props.server.owner == user._id || props.server.owner._id == user._id  && (
              <div onClick={openCreateModal} className="children-L002ao">
              <button
                aria-label="Create channel"
                tabIndex={-1}
                type="button"
                className="addButton-3bLyEA forceVisible-2L54of button-38aScr lookBlank-3eh9lL colorBrand-3pXr91 grow-q77ONN"
              >
                <div className="contents-18-Yxp">
                  <svg
                    className="addButtonIcon-2CbG1X"
                    aria-hidden="false"
                    width={18}
                    height={18}
                    viewBox="0 0 18 18"
        ...
        {props.channels &&
          props.channels.map((channel, index) => (
            <div className="containerDefault--pIXnN">
              <div
                className={`iconVisibility-sTNpHs wrapper-2jXpOf ${
                  channel._id == channelId ? `selected-channel` : ""
                }`}
                role="listitem"
              >
                <div className="content-1x5b-n">
                  <Link
                    to={`/channel/${serverId}/${channel._id}`}
                  ...
                  >
                    ...
                    <div
                      className="name-23GUGE overflow-WK9Ogt"
                      aria-hidden="true"
                    >
      ...
      <div>
        ...
        >
         <CreateChannelModal closeCreateModal={closeCreateModal}/>
        </Modal>
      </div>
    </div>
  );
