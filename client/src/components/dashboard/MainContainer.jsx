                  ...
                  <div className="base-3dtUhz">
                    <div className="content-98HsJk">
                      ...
                      {channelId ? (
                        ...
                        <div className="noChannel-3LgMRp">
                          <div
                            className="flex-1xMQg5 flex-1O1GKY vertical-V37hAW flex-1O1GKY directionColumn-35P_nr justifyCenter-3D2jYp alignCenter-1dQNNs noWrap-3jynv6 wrapper-r-6rrt"
                            style={{ flex: "1 1 auto" }}
                          >
                            <div
                              ...
                              style={{
                                ...
                                height: "222px",
                                backgroundImage:
                                  'url("/assets/ed2007aab2da31a5436e70a28b4d59f9.svg")',
                              }}
                            />
                            <div
                              ...
                              style={{ flex: "0 1 auto" }}
                            >
                              <h4 className="title-2BxgL2">No text channels</h4>
                              <div className="text-GwUZgS marginTop8-1DLZ1n">
                                You find yourself in a strange place. You don't
                                have access to any text channels, or there are
                                none in this server.
                              </div>
                            </div>
                          </div>
