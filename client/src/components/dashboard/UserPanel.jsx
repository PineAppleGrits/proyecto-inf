...
const UserPanel = (props) => {
    const {auth} = props;
    const {user} = auth;
    const [showUserModal, setModalOpen] = React.useState(false);
  ...
  return (
    <section className="panels-j1Uci_" aria-label="User area">
      <div className="wrapper-24pKcD" />
      <div className="container-3baos1">
        <div
          className="avatarWrapper-2yR4wp"
          aria-controls="popout_43"
          aria-expanded="false"
        ...
        >
          <div
            className="avatar-SmRMf2 wrapper-3t9DeA"
            role="img"
        ...
        <div
          className="nameTag-3uD-yy canCopy-2VBT7N"
          aria-label="Click to copy username"
          role="button"
          tabIndex={0}
        >
          <div className="colorStandard-2KCXvj size14-e6ZScH usernameContainer-1fp4nu">
            <div className="size14-e6ZScH title-eS5yk3">{user.name}</div>
          </div>
          <div className="size12-3cLvbJ subtext-3CDbHg">
            <div className="hoverRoll-YK53gQ">
              <div className="hovered-d5PMVU">#{user.discriminator}</div>
              <div className="default-3sgIpy">
                <div className="customStatus-3tC2ig">
                  <span>Just an user</span>
                </div>
              </div>
            </div>
          </div>
