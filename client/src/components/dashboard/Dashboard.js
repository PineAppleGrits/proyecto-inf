      ...
      <div id="app-mount" className="appMount-3lHmkl">
        <div>
          <svg
            ...
            aria-hidden="true"
            style={{
              position: 'absolute', pointerEvents: 'none', top: '-1px', left: '-1px', width: '1px', height: '1px',
            }}
          >
            ...
            <mask id="svg-mask-avatar-default" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><circle fill="white" cx="0.5" cy="0.5" r="0.5" /></mask>
            ...
            <mask id="svg-mask-status-online" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><circle fill="white" cx="0.5" cy="0.5" r="0.5" /></mask>
            ...
            <mask id="svg-mask-status-typing" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><rect fill="white" cx={0} cy={0} width={1} height={1} ry="0.5" rx="0.2" /></mask>
            ...
            <mask id="svg-mask-event-ticket" maskContentUnits="objectBoundingBox" viewBox="0 0 1 1"><path d="M0 0.12C0 0.0779961 0 0.0569941 0.00408726 0.0409507C0.00768251 0.0268386 0.0134193 0.015365 0.0204754 0.00817451C0.028497 0 0.038998 0 0.06 0H0.94C0.961002 0 0.971503 0 0.979525 0.00817451C0.986581 0.015365 0.992318 0.0268386 0.995913 0.0409507C1 0.0569941 1 0.0779961 1 0.12V0.45C0.986193 0.45 0.975 0.472386 0.975 0.5C0.975 0.527614 0.986193 0.55 1 0.55V0.88C1 0.922004 1 0.943006 0.995913 0.959049C0.992318 0.973161 0.986581 0.984635 0.979525 0.991826C0.971503 1 0.961002 1 0.94 1H0.0600001C0.0389981 1 0.028497 1 0.0204754 0.991826C0.0134193 0.984635 0.00768251 0.973161 0.00408726 0.959049C0 0.943006 0 0.922004 0 0.88V0.55C0.0138071 0.55 0.025 0.527614 0.025 0.5C0.025 0.472386 0.0138071 0.45 0 0.45V0.12Z" fill="white" /></mask>
          </svg>
          <svg
            viewBox="0 0 1 1"
            aria-hidden="true"
          ...
          >
            <linearGradient id="e4ba6c38-6a94-4f84-8552-f91b40bf01f1">
            ...
            <linearGradient id="9e73fe9e-046c-4081-9dee-562d97c6485f">
            ...
            <linearGradient id="68903383-89d1-4598-b112-6b1faa49a3b6">
            ...
            <linearGradient id="8e4b7f77-6c04-4d5f-b783-019e83caaa8d">
                ...
                <div className="container-2lgZY8">
                  ...
                  <div className="base-3dtUhz">
                    <div className="content-98HsJk">
                      ...
                      <div className="peopleColumn-29fq28" role="tabpanel" id="online-tab">
                        <div className="emptyStateContainer-2HsLQm">
                          <div className="friendsEmpty-1K9B4k" style={{ opacity: 1 }}>
                            <div className="flex-1xMQg5 flex-1O1GKY vertical-V37hAW flex-1O1GKY directionColumn-35P_nr justifyCenter-3D2jYp alignCenter-1dQNNs noWrap-3jynv6 wrapper-r-6rrt" style={{ flex: '1 1 auto' }}>
                              <div
                                className="image-1GzsFd marginBottom40-2vIwTv"
                                style={{
                                  flex: '0 1 auto', width: '421px', height: '218px', backgroundImage: 'url("/assets/b36de980b174d7b798c89f35c116e5c6.svg")',
                                }}
                              />
                              <div className="flexChild-faoVW3" direction="vertical-V37hAW flex-1O1GKY directionColumn-35P_nr" style={{ flex: '0 1 auto' }}><div className="text-GwUZgS marginTop8-1DLZ1n">No one's around to play with Wumpus.</div></div>
                            </div>
                          </div>
                        </div>
                      </div>
